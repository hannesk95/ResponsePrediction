...
def conv3x3x3(in_planes, out_planes, stride=1):
    return ModuleParallel(nn.Conv3d(in_planes,
                     out_planes,
                     kernel_size=3,
                     stride=stride,
                     padding=1,
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = ModuleParallel(nn.Conv3d(n_input_channels,
                               self.in_planes,
        ...
        self.avgpool = ModuleParallel(nn.AdaptiveAvgPool3d((1, 1, 1)))
        self.fc = ModuleParallel(nn.Linear(block_inplanes[3] * block.expansion, n_classes))
